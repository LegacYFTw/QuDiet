...
GIT = 'https://github.com/LegacYFTw/qubit-qudit-sim'
AUTHOR_LIST = ["Turbasu Chatterjee", "Subhayu Kumar Bala", "Arnav Das"]
SUPERVISOR_LIST = ["Dr. Amit Saha", "Prof. Anupam Chattopadhyay", "Prof. Amlan Chakrabarti"]
...
license_header_lines = [
    # "# ========================================================================== #\n",
    # "#\n",
    f"#               This file is part of the {NAME} package.\n",
    f"#              {GIT}\n",
    "#\n",
    f"#                      Copyright (c) {YEAR}.\n",
    "#                      --.- ..- -.. .. . -\n",
